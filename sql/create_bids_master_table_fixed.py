#!/usr/bin/env python3
"""
Bids Master Table Creation Script (Fixed)
    ...
    try:
        ...
        if connection.is_connected():
            ...
            CREATE TABLE IF NOT EXISTS bids_master (
                ...
                published_by INT NULL COMMENT 'User ID who published the bid',
                published_at TIMESTAMP NULL COMMENT 'When the bid was published',
                closed_by INT NULL COMMENT 'User ID who closed the bid',
                closed_at TIMESTAMP NULL COMMENT 'When the bid was closed',
                awarded_by INT NULL COMMENT 'User ID who awarded the bid',
            ...
            CREATE TABLE IF NOT EXISTS bid_lanes (
                id INT AUTO_INCREMENT PRIMARY KEY,
                bid_id INT NOT NULL COMMENT 'Reference to bids_master',
                lane_id INT NOT NULL COMMENT 'Reference to lanes table',
            ...
            CREATE TABLE IF NOT EXISTS bid_carriers (
                id INT AUTO_INCREMENT PRIMARY KEY,
                bid_id INT NOT NULL COMMENT 'Reference to bids_master',
                carrier_id INT NOT NULL COMMENT 'Reference to carriers table',
